<div id="main-div">
    ...
    <form class="row mx-auto" wire:submit.prevent="store()">
        ...
        <div class="form-group col-12 col-lg-6">
            ...
            <select required wire:model="state" id="state" class="form-control mb-2">
        ...
        <div class="form-group col-12 col-lg-6">
            ...
            <select required wire:model="country" id="country" class="form-control mb-2">
